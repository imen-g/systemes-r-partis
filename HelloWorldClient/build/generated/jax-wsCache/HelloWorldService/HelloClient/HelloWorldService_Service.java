 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://helloworld/", wsdlLocation = "http://localhost:8081/WS_HelloWorld/HelloWorldService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/WS_HelloWorld/HelloWorldService?wsdl");
    ...
    public HelloWorldService getHelloWorldServicePort() {
        return super.getPort(new QName("http://helloworld/", "HelloWorldServicePort"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorldServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloworld/", "HelloWorldServicePort"), HelloWorldService.class, features);
    }
